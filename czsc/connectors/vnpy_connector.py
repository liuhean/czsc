...
#     "密码": "121251",
#     "经纪商代码": "9060",
#     "交易服务器": "120.136.160.68:33437",
#     "行情服务器": "120.136.160.68:33441",
#     "产品名称": "client_xinghuo668_1.68",
#     "授权编码": "DCQFVVGFIEP3ZG72"
# }
# 测试simnow
ctp_setting = {
    "用户名": "225076",
...
def vnpy_run():
    ...
    # print('cta_engine.strategies.keys()',cta_engine.strategies.keys())
    for symbol in params['symbols']:
        # print('f"{symbol}_{cta_strategy_list[0]}"', f"{symbol}_{cta_strategy_list[0]}")
        # print('f"{symbol}_{cta_strategy_list[0]}" not in cta_engine.strategies.keys()',
        # f"{symbol}_{cta_strategy_list[0]}" not in cta_engine.strategies.keys())
